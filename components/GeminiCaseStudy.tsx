  ...
  return (
    <article className="case-study">
      <div className="case-study-shell">
        ...
        {/* Pre-feedback explorations — not the final design */}
        <section className="case-study-section case-study-section--visual">
          ...
          <div className="case-study-teaser-grid case-study-teaser-grid--draft">
            <figure className="case-study-figure case-study-figure--wide">
              <div className="case-study-frame case-study-frame--draft">
                <Image
              ...
              <figcaption className="case-study-caption">Markets · news stream</figcaption>
            </figure>
            <figure className="case-study-figure">
              ...
              <figcaption className="case-study-caption">In-app dark mode</figcaption>
            </figure>
            <figure className="case-study-figure">
              <div className="case-study-frame case-study-frame--draft">
                <Image
              ...
              <figcaption className="case-study-caption">In-app light mode</figcaption>
            </figure>
          </div>
        </section>
        ...
        <section className="case-study-section case-study-section--primary">
          ...
          <div className="case-study-strategy-block">
        ...
        <section className="case-study-section case-study-section--primary">
          ...
          <blockquote className="case-study-feedback">
          ...
          <div className="case-study-critique-cards">
        ...
        <section className="case-study-section case-study-section--visual">
          ...
          <div className="case-study-compare-grid">
            <figure className="case-study-figure">
              <div className="case-study-frame case-study-frame--muted">
                <Image
              ...
              <figcaption className="case-study-caption">Before · always open</figcaption>
            </figure>
            <figure className="case-study-figure">
              ...
              <figcaption className="case-study-caption">After · banner + expandable card</figcaption>
            </figure>
          </div>
        </section>
        ...
        <section className="case-study-section case-study-section--visual">
          ...
          <figure className="case-study-figure case-study-figure--wide">
            ...
            <figcaption className="case-study-caption">Blog hub · tags + breaking news</figcaption>
          </figure>
        </section>

        <aside className="case-study-gate experience-glass-panel">
